 ...
 * complete dashboard" (Andrew, 14 Sep), matching the spirit of
 * tablet-panel-milestone.md's in-van tablet panel, but driven by
 * viewport size rather than a build flag, so the same app served to a
 * phone and to a mounted tablet just renders differently on each.
 *
