    ...
    <div data-testid={HOME.root} className="mx-auto max-w-[1600px]">
      <div className="grid grid-cols-12 gap-4 lg:gap-5">
        ...
        <div className="col-span-12 lg:col-span-6 flex flex-col gap-4">
          ...
          <GlassCard glow={meta.tone === 'red' ? undefined : 'teal'} className="p-5" data-testid={HOME.sitrepBadge}>
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[10px] uppercase tracking-[0.2em] text-ink-muted">Mission brief</div>
