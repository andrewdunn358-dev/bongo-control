...
import { Droplet, Trash2, ShoppingCart, Fuel, TentTree, Caravan, Sparkles, RefreshCw, Info, Navigation, ExternalLink, Compass, SignalHigh, SignalLow, SignalZero } from 'lucide-react';
