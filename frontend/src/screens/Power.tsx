      ...
      <div className="grid grid-cols-12 gap-4 lg:gap-6">
        ...
        <GlassCard className="col-span-12 lg:col-span-6 p-6">
          ...
          <ul className="space-y-3 text-sm">
            ...
            {/* Only shown once a shunt is reporting. Tested with
                hasShunt(), NOT with current_a on its own: BATTERY has
                two publishers and the MPPT's message carries voltage
                without current, so a bare current_a test hides the
                shunt's own rows whenever the MPPT published last. That
                is the bug db01329 fixed elsewhere on this page; this
                line predates it and is corrected here. */}
            {hasShunt(bp) && (
              <>
                <li className="flex justify-between border-t border-ink/5 pt-2">
