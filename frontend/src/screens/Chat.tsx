...
/**
 * Maggie's avatar. A real photo now, not the earlier illustration —
 * still worth keeping the "AI-generated" badge visible everywhere she
 * appears (see the CardHeader below), since a photorealistic face
 * makes it easier to mistake her for an actual person at a glance.
 */
