...
export default function BottomNav() {
  return (
    <nav
      className="fixed inset-x-3 bottom-3 z-30 flex rounded-[1.6rem] border border-white/[0.08] bg-surface-card/92 p-1.5 shadow-[0_18px_50px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-xl md:hidden"
