    ...
    <div className="relative">
      <div className="grid grid-cols-12 gap-5">
        ...
        <Tile index={3} className="col-span-3">
          <GlassCard level="hero" glow="purple" className="h-full relative overflow-hidden">
        ...
        <Tile index={4} className="col-span-7">
          <GlassCard className="h-full p-0 overflow-hidden relative" style={{ minHeight: 260 }}>
            <img
        ...
        <Tile index={9} className="col-span-6">
          <GlassCard level="quiet" className="h-full" data-testid="cockpit-interior">
        ...
        <Tile index={10} className="col-span-6">
          <GlassCard level="quiet" className="h-full" data-testid="cockpit-exterior">
