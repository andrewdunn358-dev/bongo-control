...
@router.get("/nearby")
async def get_nearby(radius_m: int = 10000, categories: str = "", force_refresh: bool = False) -> dict:
    ...
    try:
        return await poi_service.search_nearby(location["latitude"], location["longitude"], radius_m, category_list, force_refresh=force_refresh)
